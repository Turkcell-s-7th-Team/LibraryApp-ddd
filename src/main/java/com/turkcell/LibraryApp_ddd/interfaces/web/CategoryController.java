...
import com.turkcell.LibraryApp_ddd.application.category.query.ListCategoriesQuery;
...
public class CategoryController {
    ...
    @GetMapping
    public List<CategoryResponse> getCategories(@Valid @ModelAttribute ListCategoriesQuery query) {
